...
Game.World = function() {
  this.player = new Game.Player(500,900);
  this.zone_id = 0;
  this.image = "";
  ...
  this.worldcollision = new Game.CollisionObject([[70,142],[39,145],[3940,2000],[7,2000]], true, this);
};
...
Game.Player.prototype = {
  ...
  moveLeft:function() { this.x_velocity -= 20; },
  moveRight:function() { this.x_velocity += 20; },
  moveUp:function() { this.y_velocity -= 10; },
  moveDown:function() { this.y_velocity += 10; },
